...
- ejecutar `/plan-iteration`.

---

### 1.2 Revisión rápida de “estado”
Antes de escribir, revisa:
- `docs/spec/95-open-questions.md` (qué bloquea)
- `docs/spec/96-todos.md` (qué quedó pendiente)
...
Después:
- el reviewer la transformará en ADR con `/review-and-adr`.
...
### 3.2 Cerrar o continuar la iteración
Según el resultado del review:

- Si hay bloqueantes:
  - aplicar cambios con Writer (otra mini-ronda Write → Review)
- Si el scope crece:
  - planificar nueva iteración (I02) con `/plan-iteration`
- Si la iteración se considera lista:
  - marcar estado como “Cerrado” en el plan.
...
- ¿El plan sigue representando lo que estamos haciendo?
