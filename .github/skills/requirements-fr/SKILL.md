...
Ejemplos
✅ Bien:
- “Dado un usuario con rol ROL-001, cuando crea un registro válido, entonces el sistema lo guarda y muestra confirmación; si faltan campos obligatorios, muestra mensajes por campo.”
❌ Mal:
